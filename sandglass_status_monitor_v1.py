...
receivers = ['813955655@qq.com', 'dan.wang@dotcunited.com', 'mengling.hao@dotcunited.com', 'linzhi.luo@avazu.net']
...
def main():
    ...
    while 1:
        ...
        if not ret.get('runtask') or not ret.get('scheduler'):
            ...
            # #发送邮件
            text = 'sandglass status check runtask:{runtask}, scheduler:{scheduler}, check it in time please'.format(**ret)
